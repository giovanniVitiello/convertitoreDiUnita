...
//
//    private lateinit var converterDetailViewModel: ConvertDetailViewModel
...
//                } else {
//                    converterDetailViewModel.sendEvent(ConvertDetailEvent.GetCelsiusFromFahrenheit(insert.text.toString()))
//                }
//            } else if (selectedItem == "celsius/fahrenait") {
//                if (insert.text.toString().isEmpty()) {
//                    Toast.makeText(this, "please enter value", Toast.LENGTH_LONG).show()
//                } else {
//                    converterDetailViewModel.sendEvent(ConvertDetailEvent.GetFahrenheitFromCelsius(insert.text.toString()))
//                }
//            } else if (selectedItem == "g/kg") {
//                if (insert.text.toString().isEmpty()) {
//                    Toast.makeText(this, "please enter value", Toast.LENGTH_LONG).show()
//                } else {
//                    converterDetailViewModel.sendEvent(ConvertDetailEvent.GetKgFromG(insert.text.toString()))
//                }
//            } else if (selectedItem == "kg/g") {
//                if (insert.text.toString().isEmpty()) {
//                    Toast.makeText(this, "please enter value", Toast.LENGTH_LONG).show()
//                } else {
//                    converterDetailViewModel.sendEvent(ConvertDetailEvent.GetGFromKg(insert.text.toString()))
//                }
...
//                    Toast.makeText(this, "please enter value", Toast.LENGTH_LONG).show()
//                } else {
//                    converterDetailViewModel.sendEvent(ConvertDetailEvent.LoadGbp(insert.text.toString()))
//                }
//            }
//        }
//
